...
export const HERO_CONTENT = `I am a Computer Science student at the University of California, Irvine, with a strong interest in Full Stack Development. Through coursework and projects, I have honed my skills in languages such as Python and JavaScript, as well as technologies such as React, Express, Flask, PostgreSQL, and Tailwind. I am eager to gain hands-on experience in software development and contribute to impactful projects that solve real-world problems.`;
...
export const PROJECTS = [
  {
    ...
    technologies: ["Node", "Express", "React", "Tailwind", "PostgreSQL", "Redis"],
  ...
  },
  {
    ...
    technologies: ["Node", "React", "Firebase"],
